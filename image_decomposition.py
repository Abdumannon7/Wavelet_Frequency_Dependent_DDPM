...
def idwt_matrix(size, wavelet_name='haar'):
    ...
    print(torch.tensor(matrix_Low_syn,  dtype=torch.float32))
    print(torch.tensor(matrix_High_syn, dtype=torch.float32))
